...
#f = open(Simplenn_exp_labels_1, "wb")
...
plt.savefig('Simplenn_exp_model_plot_save_1.png')

'''
Experiment-1-normal 2 conv layer
Epoch 10/10
75/75 [==============================] - 23s 305ms/step - loss: 0.5842 - accuracy: 0.7208 - val_loss: 0.8640 - val_accuracy: 0.6700
curacy: 0.7183
'''